...
namespace Heimseiten\ContaoArticleListWithCssClassesAndIdsBundle\DependencyInjection;
...
class HeimseitenContaoArticleListWithCssClassesAndIdsExtension extends Extension
{
    /**
     * @throws \Exception
     */
